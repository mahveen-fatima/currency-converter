...
// taking countries from array and showing in select tag
...
fromAmountElement.addEventListener("input", getExchangedRate);

// fetching exchange rate when user change currency
fromCurrencyElement.addEventListener("change", getExchangedRate);
toCurrencyElement.addEventListener("change", getExchangedRate);
window.addEventListener("load", getExchangedRate);
